...
export default function ScrollToTop() {
	...
	return (
		<button
			...
			className={`fixed z-[60] rounded-full bg-brand-500 text-white shadow-md hover:bg-brand-600 transition-colors cursor-pointer ${visible ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
			style={{
				width: 44,
				height: 44,
