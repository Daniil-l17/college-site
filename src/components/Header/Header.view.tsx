		...
		<header className='sticky top-0 left-0 right-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-black/10'>
			<div className='mx-auto max-w-6xl px-4 py-4 flex items-center justify-between'>
				...
				<div className='flex items-center gap-3'>
					...
					<a
						href='https://github.com/Daniil-l17/college-site'
						target='_blank'
						rel='noopener noreferrer'
						className='flex items-center gap-2 text-sm rounded-md px-3 py-2 bg-gray-800 hover:bg-gray-700 text-white transition-colors button-lift cursor-pointer'
					>
